...
public class TimeslicedMetricDataPerAgentMetric  implements java.io.Serializable {
    private webservices.introscope.wily.ca.AgentMetricName agentMetric;

    private int metricType;

    private webservices.introscope.wily.ca.TimeslicedResultPerMetricData[] timeslicedMetricData;

    public TimeslicedMetricDataPerAgentMetric() {
    }

    public TimeslicedMetricDataPerAgentMetric(
           webservices.introscope.wily.ca.AgentMetricName agentMetric,
           int metricType,
           webservices.introscope.wily.ca.TimeslicedResultPerMetricData[] timeslicedMetricData) {
     ...
     * @return agentMetric
     */
    public webservices.introscope.wily.ca.AgentMetricName getAgentMetric() {
        return agentMetric;
    }
     ...
     * @param agentMetric
     */
    public void setAgentMetric(webservices.introscope.wily.ca.AgentMetricName agentMetric) {
        this.agentMetric = agentMetric;
    }
     ...
     */
    public webservices.introscope.wily.ca.TimeslicedResultPerMetricData[] getTimeslicedMetricData() {
        return timeslicedMetricData;
    }
     ...
     */
    public void setTimeslicedMetricData(webservices.introscope.wily.ca.TimeslicedResultPerMetricData[] timeslicedMetricData) {
        this.timeslicedMetricData = timeslicedMetricData;
    }
