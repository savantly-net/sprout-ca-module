/**
 * TimeslicedResultSetMetricData.java
 *
...
public class TimeslicedResultSetMetricData  implements java.io.Serializable {
    private webservices.introscope.wily.ca.MetricData[] metricData;

    private java.util.Calendar timesliceEndTime;

    private java.util.Calendar timesliceStartTime;

    public TimeslicedResultSetMetricData() {
    }

    public TimeslicedResultSetMetricData(
           webservices.introscope.wily.ca.MetricData[] metricData,
    ...
    /**
     * Gets the metricData value for this TimeslicedResultSetMetricData.
     * 
     * @return metricData
     */
    public webservices.introscope.wily.ca.MetricData[] getMetricData() {
        return metricData;
    }


    /**
     * Sets the metricData value for this TimeslicedResultSetMetricData.
     * 
     * @param metricData
     */
    public void setMetricData(webservices.introscope.wily.ca.MetricData[] metricData) {
        this.metricData = metricData;
    }


    /**
     * Gets the timesliceEndTime value for this TimeslicedResultSetMetricData.
     * 
    ...
    /**
     * Sets the timesliceEndTime value for this TimeslicedResultSetMetricData.
     * 
    ...
    /**
     * Gets the timesliceStartTime value for this TimeslicedResultSetMetricData.
     * 
    ...
    /**
     * Sets the timesliceStartTime value for this TimeslicedResultSetMetricData.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TimeslicedResultSetMetricData)) return false;
        TimeslicedResultSetMetricData other = (TimeslicedResultSetMetricData) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TimeslicedResultSetMetricData.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:ca.wily.introscope.webservices", "TimeslicedResultSetMetricData"));
